    ...
    <Layout>
      ...
      <section className="pt-16 pb-8 md:pt-20 md:pb-12 bg-background">
        <div className="container-luxury">
          <span className="text-primary font-sans text-sm uppercase tracking-widest mb-4 block">Get in Touch</span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-foreground mb-6">Let's Create Together</h1>
      ...
      <section className="section-padding bg-card border-t border-border/30">
        <div className="container-luxury">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-sans text-muted-foreground mb-2">Name</label>
                    <input
                      type="text"
                      required
                      value={formData.name}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-sans text-muted-foreground mb-2">Mobile Number</label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label className="block text-sm font-sans text-muted-foreground mb-2">Company</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-sm font-sans text-muted-foreground mb-3">Services Interested In</label>
                ...
                <div>
                  <label className="block text-sm font-sans text-muted-foreground mb-2">Project Details</label>
                  <textarea
                    rows={5}
            ...
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-serif text-foreground mb-8">Contact Information</h2>
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground font-sans text-sm leading-relaxed">
                      3rd Floor, Room 304, Sagar Trade Cube,
                      <br />
                      104, Shyama Prasad Mukherjee Rd,
                      <br />
                ...
                <a href="mailto:contact@creativekult.com" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground font-sans text-sm">contact@creativekult.com</p>
                  </div>
                </a>
                ...
                <a
                  ...
                  className="flex items-start gap-4 group"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-primary flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground font-sans text-sm">+91 90739 86777</p>
                  </div>
                </a>

                {/* Social Media */}
                <div>
                  <h3 className="text-foreground font-sans font-medium mb-4">Follow Us</h3>
              ...
              <div className="mt-12">
                <h2 className="text-2xl md:text-3xl font-serif text-foreground text-center mb-8">Our Location</h2>

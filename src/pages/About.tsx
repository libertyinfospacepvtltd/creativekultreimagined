  ...
  return <Layout>
      ...
      <section className="section-padding bg-card border-t border-border/30 py-[50px]">
        <div className="container-luxury">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 my-[50px]">
            ...
            <div className="flex-shrink-0">
              <img src={theme === 'dark' ? logoDark : logoLight} alt="Creative Kult Logo" className="w-48 sm:w-64 md:w-72 lg:w-80 h-auto opacity-90" />
            </div>
          </div>
        </div>
      </section>

...
const values = [
  { icon: Heart, title: "Passion-Driven", description: "We pour our heart into every project, treating your brand as our own." },
  { icon: Users, title: "Collaborative", description: "We believe the best work comes from true partnerships with our clients." },
  { icon: Award, title: "Excellence", description: "We set the bar high and consistently deliver beyond expectations." },
  { icon: MapPin, title: "Rooted in Kolkata", description: "We draw inspiration from our city's rich artistic heritage and cultural depth." },
];
...
const About = () => {
  return (
    <Layout>
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-16 md:pt-40 md:pb-20 bg-background">
        ...
        <div className="container-luxury">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {values.map((value, index) => (
              <div key={index} className="text-center p-6 sm:p-8 border border-border/30 hover:border-primary/30 transition-colors duration-300">

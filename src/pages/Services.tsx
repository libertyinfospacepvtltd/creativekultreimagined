    ...
    <div className="block md:hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Price */}
          <div className="mb-6">
            <span className="text-4xl font-numbers font-bold text-primary tracking-tight tabular-nums">{activeTier.price}</span>
        ...
        <div className="container-luxury">
          ...
          <div className="hidden md:grid grid-cols-3 gap-8">
            ...
            <div className="flex flex-col p-8 rounded-3xl bg-white/80 dark:bg-white/5 border border-border/30 dark:border-amber-500/30 shadow-xl dark:shadow-none transition-all duration-300 hover:shadow-2xl dark:hover:border-amber-500/50">
              ...
              <div className="mb-6">
                <span className="text-5xl font-numbers font-bold text-primary tracking-tight tabular-nums">₹25,000</span>
            ...
            <div className="flex flex-col p-8 rounded-3xl bg-white/80 dark:bg-white/5 border-2 border-primary shadow-xl dark:shadow-none transition-all duration-300 hover:shadow-2xl relative">
              ...
              <div className="mb-6">
                <span className="text-5xl font-numbers font-bold text-primary tracking-tight tabular-nums">₹50,000</span>
            ...
            <div className="flex flex-col p-8 rounded-3xl bg-white/80 dark:bg-white/5 border border-border/30 dark:border-amber-500/30 shadow-xl dark:shadow-none transition-all duration-300 hover:shadow-2xl dark:hover:border-amber-500/50">
              ...
              <div className="mb-6">
                <span className="text-5xl font-numbers font-bold text-primary tracking-tight tabular-nums">₹1,00,000</span>
                <span className="text-muted-foreground font-sans text-sm ml-2">/month</span>
              </div>
              <p className="text-muted-foreground font-sans text-sm mb-6">
        ...
        <div className="container-luxury">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="flex flex-col items-center justify-center p-5 sm:p-8 rounded-3xl bg-[#FAF9F6] dark:bg-white/5 transition-all duration-300 hover:scale-[1.02]">
              ...
              <span className="text-primary font-numbers font-bold text-2xl sm:text-3xl md:text-4xl mb-1 tracking-tight tabular-nums">
                ₹15,000
              </span>

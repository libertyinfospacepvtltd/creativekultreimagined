            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="text-muted-foreground hover:text-primary transition-colors text-sm font-sans min-h-[44px] py-1 inline-flex items-center"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <a 
                  ...
                  className="flex items-start gap-3 text-muted-foreground hover:text-primary transition-colors text-sm font-sans py-1"
                >

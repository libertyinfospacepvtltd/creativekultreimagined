...
const Layout = ({ children }: LayoutProps) => {
  ...
  const [logoHandoffReady, setLogoHandoffReady] = useState(!isHomePage);

  const handleLogoReady = useCallback(() => {
    setLogoHandoffReady(true);
  }, []);
  ...
  return (
    <LayoutGroup>
      <div className="min-h-screen bg-background relative">
        ...
        {/* Only show after logo handoff is ready from preloader */}
        {logoHandoffReady && <DockingLogo isReady={logoHandoffReady} />}
